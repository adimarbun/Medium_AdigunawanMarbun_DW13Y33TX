    ...
    <Grid >
        ...
        <Grid  xs={12} className="container-cover"  >
            <Grid container xs={12} className="grid-profile" >
                <Grid item xs={10} >
                    <Grid container xs={12}>
                        ...
                        <Button variant="outlined" style={{
                            width:"50px",height:"30px",margin:"5px 0 0 20px",textTransform:"capitalize",fontSize:"12px"
                        }} >Follow</Button>
                    </Grid>
                    <p>Bets selling Authors of "Conspirasy",Ego is the Enemy '&' The Obstacle Is The Way</p>
                </Grid>
                <Grid item xs={2} >
                ...
                <Grid container>
                    <Typography style={{marginRight:"20px"}}>100 Following </Typography>  
                    <Typography style={{marginRight:"20px"}}>200k Followers</Typography> 
                    <TwitterIcon/>
                </Grid >  
            </Grid>
            <AppBar position="static" color="inherit"  style={{boxShadow:"none"}}>
                <Grid item xs={12} >
                    ...
                    >
                        <LinkTab className={classes.button} label="Profile" href="/drafts" {...a11yProps(0)} />
                        <LinkTab className={classes.button} label="Claps" href="/trash" {...a11yProps(1)} /> 
                        <LinkTab className={classes.button} label="Highlight" href="/trash" {...a11yProps(2)} />
                        <LinkTab className={classes.button} label="Responses" href="/trash" {...a11yProps(3)} />
                    </Tabs>
                </Grid>
            </AppBar>
                            ...
                            <Grid container  wrap="nowrap" >
                                <Grid item xs={12} >
                                    ...
                                    <Typography variant ="h5"
                                        key={followItem.id}>{followItem.title}
                                    </Typography>
                                    <Typography
                                        key={followItem.id}>{followItem.title}
                                    </Typography>
