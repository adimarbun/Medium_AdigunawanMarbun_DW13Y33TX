                ...
                <div style={{margin:"50px 18% 10px 18%"}}>
                    ...
                    <Paper >       
                        <Grid container  wrap="nowrap" style={{width:"62vw" ,margin:"10px 10px 10px 10px"}}>
                            ...
                            <Grid item xs={3} >
                            <IconButton  >
                                <ThumbUpAltIcon color="primary"/>300k
                            </IconButton>
                            <IconButton  >
                                <ChatBubbleOutlineIcon color="primary" />1.5 k
                            </IconButton>  
                            </Grid>
                        </Grid>
                    </Paper>
                ...
                <div className="follow-root">
                    ...
                    <Typography variant="h5">
                        ...
                        <Paper style={{margin:"20px 0 20px 0"}}>       
                            <Grid container  wrap="nowrap" style={{width:"62vw" ,margin:"10px 0 10px 0"}}>
                                <Grid item xs={1} >
                                ...
                                <Grid item xs={11} >
                                    <TextField id="outlined-basic" label="Write a response..." variant="outlined" fullWidth /> 
                                </Grid>
                            </Grid>
                        </Paper>
                        ...
                        <Paper style={{margin:"10px 0 10px 0"}}>
                            <Grid >
                                <Grid container  wrap="nowrap" style={{width:"62vw" ,margin:"10px 0 0 0"}}>
                                    <Grid item xs={1} >
                                        <Fab color="primary" aria-label="image"
                                            key={followItem.image}>{followItem.image}
                                        </Fab>  
                                    </Grid>
                                    <Grid item xs={9} >
                                        <Typography variant="h6"
                                            key={followItem.id}><strong>{followItem.name}</strong>      
                                        </Typography> 
                                        <p 
                                            key={followItem.id}>{followItem.date}      
                                        </p>
                                    </Grid>
                                </Grid>
                            </Grid>
                            <Grid item xs={12}container >
                                <Grid container  wrap="nowrap" style={{width:"60vw" ,margin:"0 10px 10px 10px"}}>
                                    <Grid item xs={12} >
                                        <Typography
                            ...
                            <Grid container  wrap="nowrap" style={{width:"62vw" }}>
                                <Grid item xs={9} style={{margin:"0 10px 10px 0"}} >
                                    <IconButton  >
                                        <ThumbUpAltIcon color="primary" key={followItem.id}/>{followItem.like}
                                    </IconButton>  
                                </Grid>
