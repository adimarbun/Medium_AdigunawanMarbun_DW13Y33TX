            ...
            <Link href="articelDetail" color="inherit" underline="none">
              ...
              <div style={{ marginLeft: "60px" }}>
                ...
                <p>
                  ...
                  more productive and inwardly focused, where should you start?
                </p>
              </div>
            </Link>
          </Grid>
          <Grid item xs>
            <div>
              <Grid container wrap="nowrap" spacing={2}>
                ...
                <Grid item xs>
                  <Typography>
                    7 Reasons Why Smart, Hardworking People Don’t Become
                    Successful
          ...
          <Grid item xs>
            <div>
              ...
              <div style={{ marginRight: "50px" }}>
                ...
                <p>
                  Ten years later, after thirty years of marriage, I stopped
                  hoping .after thirty years of marriage Why I Divorced My
